    ...
    public partial class Initialization : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComparisonProducts", x => new { x.ComparisonId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_ComparisonProducts_Comparisons_ComparisonId",
                        column: x => x.ComparisonId,
                        principalTable: "Comparisons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComparisonProducts_Products_ProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteProducts", x => new { x.FavoriteId, x.ProductsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComparisonProducts_ProductsId",
